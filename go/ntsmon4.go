...
func main() {
	...
	RunQuery(*serverPtr, uint8(*stratumPtr), *verbosePtr, *insecurePtr, *requestedServerPtr, *requestedPortPtr)
}

func RunQuery(host string, stratum uint8, verbose, insecure bool, requestedServer, requestedPort string) {
